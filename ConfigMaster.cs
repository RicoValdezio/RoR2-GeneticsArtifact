...
namespace GeneticsArtifact
{
    internal class ConfigMaster
    {
        ...
        {
            GeneticMasterController.maxTrackers = GeneticsArtifactPlugin.Instance.Config.Bind(new ConfigDefinition("Master Settings", "Maximum General Purpose Trackers"), 1, new ConfigDescription("If the Tracker Per Type flag is false, this is the maximum number of genetic families that will exist during a run.")).Value;
